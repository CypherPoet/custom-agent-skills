...
# Install this plugin
/plugin install obsidian-plugin-kit@cypherpoet-toolchest
```

On Codex, add the same marketplace: `codex plugin marketplace add CypherPoet/cypherpoet-toolchest`, then `codex plugin add obsidian-plugin-kit@cypherpoet-toolchest`.
