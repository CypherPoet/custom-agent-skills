...
# Install this plugin
/plugin install cypherpoet-session-harvest@cypherpoet-toolchest
```
...
| [skill-harvest](skills/skill-harvest/SKILL.md) | Route session/project learnings into the user's own skill repos as approved PRs. |
