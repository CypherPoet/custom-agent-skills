...
- **Landscape:** most accepted sizes are the portrait sizes transposed (swap width × height).
  The legacy 4" and 3.5" no-status-bar sizes are exceptions; their accepted landscape heights
  are 600 px. Those rows list both orientations explicitly.
...
| 4" | Portrait: 640×1096 (no status bar) · 640×1136 (with status bar); landscape: 1136×600 (no status bar) · 1136×640 (with status bar) | iPhone SE (1st gen), 5S, 5C, 5 | scaled from 4.7" |
| 3.5" | Portrait: 640×920 (no status bar) · 640×960 (with status bar); landscape: 960×600 (no status bar) · 960×640 (with status bar) | iPhone 4S, 4 | scaled from 4" |
...
| 9.7" | 1536×2008 (no status bar) · 1536×2048 (with) · 768×1004 (no status bar) · 768×1024 (with) | iPad Pro 9.7", iPad Air / Air 2, iPad (2nd–6th gen), iPad mini 2–5 | scaled from 10.5" |
