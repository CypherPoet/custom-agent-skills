# cypherpoet-changelog-maintenance

Maintain a project's CHANGELOG.md in Keep-a-Changelog format.
...
# Install this plugin
/plugin install cypherpoet-changelog-maintenance@cypherpoet-toolchest
```
