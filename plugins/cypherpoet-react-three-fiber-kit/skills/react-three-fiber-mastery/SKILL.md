...
- [`threejs-mastery` skill](../../../cypherpoet-threejs-kit/skills/threejs-mastery/SKILL.md) — sibling skill for Three.js itself beneath the reconciler (a declared dependency of this plugin).
