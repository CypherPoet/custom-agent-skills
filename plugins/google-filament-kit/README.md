...
# Install this plugin
/plugin install google-filament-kit@cypherpoet-toolchest
```
...
| Raw WebGL / WebGL2 — buffers, shaders, draw calls, the GPU pipeline? | [webgl-kit](https://github.com/CypherPoet/custom-agent-skills/tree/main/plugins/webgl-kit) |
| Scene-graph 3D on the web with Three.js? | [threejs-kit](https://github.com/CypherPoet/custom-agent-skills/tree/main/plugins/threejs-kit) |
