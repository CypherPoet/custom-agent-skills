...
- [Physical light units (the trap)](#physical-light-units-the-trap)
- [Direct lighting](#direct-lighting)
  - [Directional lights (sun)](#directional-lights-sun)
  - [Point lights](#point-lights)
  - [Spot lights](#spot-lights)
  - [Falloff / influence radius](#falloff--influence-radius)
  - [Photometric (IES) lights](#photometric-ies-lights)
  - [Area lights](#area-lights)
  - [Light color & color temperature](#light-color--color-temperature)
  - [Pre-exposed lights](#pre-exposed-lights)
