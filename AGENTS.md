...
- Run `python3.11 -m unittest discover -s tests` before any PR; [`.github/workflows/verify.yml`](.github/workflows/verify.yml) runs the same suite on every PR and push to `main`.
