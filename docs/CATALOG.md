...
| [marketplace-kit](../plugins/marketplace-kit/README.md) | Maintainer toolkit for running a plugin marketplace with Claude Code and Codex catalogs — publish plugins, audit marketplace and catalog sync, and regenerate the local catalog. | 4 skills |
...
| [teach](../plugins/teach/README.md) | Build a stateful, mission-driven learning workspace with short interactive lessons, trusted resources, and durable learning records. | 1 skill |
