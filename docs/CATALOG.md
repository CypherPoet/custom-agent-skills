...
| [cypherpoet-session-harvest](../plugins/cypherpoet-session-harvest/README.md) | Run a pre-exit sweep of a conversation for learnings worth preserving, routing each to its right home: a memory, or a suggested repo edit (CLAUDE.md/AGENTS.md, docs, or a hook). | 2 skills |
