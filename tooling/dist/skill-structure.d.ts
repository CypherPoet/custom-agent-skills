...
export declare const FACT_CHECK_MANIFEST = "docs/automated-routines/skill-fact-check-manifest.json";
...
export declare function factCheckTierFindings(root: string, units: ReadonlySet<string>, unitsWithSources: ReadonlySet<string>): {
    advisories: string[];
    checked: boolean;
};
